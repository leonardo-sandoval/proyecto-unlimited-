        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="<?php echo base_url('dashboard')?>"><span>Unlimited technology</span></a>
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#"><i class="halflings-icon user"></i> Pelfil</a></li>
                                    <li><a href="<?php echo base_url('logout')?>"><i class="halflings-icon off"></i> Fin de la sesíon</a></li>
                                </ul>
                            </li>
                            <!-- end: User Dropdown -->
                        </ul>

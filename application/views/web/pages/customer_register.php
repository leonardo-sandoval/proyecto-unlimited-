...
<div class="main">
    <div class="content" style="text-align: center">
        <div class="register_account" style="text-align:center;display:inline-block;float: none; background:#15191d; color:#315174;">
            ...
            <form method="post" action="<?php echo base_url('customer/save');?>">
                <table>
                    <tbody>
                        <tr style="background:#15191d; color:#315174;">
                            <td>
                                <div>

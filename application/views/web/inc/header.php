...
<body style="background:#15191d; color:#315174;">
    <div class="">
            ...
            <div class="header_top_right">
                <div class="search_box">
                    <form method="get" action="<?php echo base_url('search')?>">
                        <input type="text" placeholder="Busacador de productos" name="search">
                ...
                <div class="shopping_cart">
                    <div class="cart">
                        <a href="<?php echo base_url('cart');?>" title="View my shopping cart" rel="nofollow">
                            <span class="cart_title">Carito</span>
                ...
                if ($customer_id) {
                    ?>
                    <div class="login"><a href="<?php echo base_url('/customer/logout'); ?>">⚙️ </a></div>
                <?php } else {
                    ?>
                    <div class="login"><a href="<?php echo base_url('/customer/login'); ?>">⚙️</a></div>
        ...
        <div class="menu">
            <ul id="dc_mega-menu-orange" style="float:left" class="dc_mm-orange">
                ...
                ?>"><a href="<?php echo base_url('/product'); ?>">Productos</a> </li>
                    <?php if ($this->cart->total_items()) { ?>
                    <li class="<?php
                    if ($this->uri->uri_string() == 'cart') {
                        echo "";
                    }
                    ?>"><a href="<?php echo base_url('/cart'); ?>">Carito</a></li>
                    <?php } ?>
                <li class="<?php
                if ($this->uri->uri_string() == 'contact') {
                    echo "activ";
                }
                ?>"><a href="<?php echo base_url('/contact'); ?>">Contactos</a> </li>
                ...
                ?>"><a href="<?php echo base_url('/customer/register'); ?>">Registro</a> </li>
